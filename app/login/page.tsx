...
export const metadata: Metadata = {
  title: 'Sign In',
  description: 'Sign in to your AcadBridge account',
}

export default async function LoginPage({
  searchParams,
}: {
  searchParams: { redirectedFrom?: string; role?: string; error?: string }
}) {
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      {/* Background */}
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 h-[600px] w-[600px] rounded-full bg-brand-700/10 blur-[120px]" />
      </div>
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <AuthForm mode="login" defaultRole={searchParams.role} />
